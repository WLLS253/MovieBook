    ...
    if ($window.scrollTop() > 35) { showElem(); } else { hideElem(); }

    //handlers    
    $window.scroll(function() {
        if ($(this).scrollTop() > 35) { showElem(); } else { hideElem(); }
    });
    ...
    function init_BookingTwo_2() {
        ...
        $('.booking-form').submit(function(e) {
            ...
            if (control == "Purchase") { action = 'book3-buy.html'; } else if (control == "Reserve") { action = 'book3-reserve.html'; }
    ...
    function init_MoviePage() {
        ...
        axios.get('http://localhost:8081/movie/getCommentList', {
                params: {
                    movieId: mid,
        ...
        date[2] = sdate[1];
        date = date.join('/');
        axios.get('http://localhost:8081/cinema/movieScheduals', {
                params: {
                    movie_id: mid,
                    date: date
