...
<body>
    <div class="wrapper">
        ...
        <section class="container">
            <h2 class="heading heading--outcontainer heading--top">heading</h2>
            ...
            <h2 class="heading heading--outcontainer heading--top">lists</h2>
            ...
            <div class="list-wrapper">
                ...
                <div class="col-md-3">
                    <div class="category category--popular">
                ...
                <div class="col-md-3">
                    <div class="category category--light categoty--position" style='margin-top:50px;'>
                        <ul>
                            <li class="category__item category__item--static">Showtimes &amp; Tickets (12345)</li>
                            <li class="category__item category__item--static">Latest Trailers (3153)</li>
                            <li class="category__item category__item--static">Coming Soon (3153)</li>
                            <li class="category__item category__item--static">In Theaters (31)</li>
                            <li class="category__item category__item--static">Release Calendar (314)</li>
                        </ul>
                    </div>
                </div>
            </div>
