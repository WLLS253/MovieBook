...
<body>
    <div class="wrapper">
        ...
        <section class="container">
            ...
            <div class='icon-block col-sm-12'>
                <h2 class="heading heading--top">Icons</h2>
                  ...
                  <h2 class="heading heading--top">Social icons</h2>
            ...
            <div class="col-sm-12">
                <div class="devider"></div>
                    ...
                    <div class="clearfix"></div>
                   <h2 class="heading heading--outcontainer heading--top">Usage</h2>

                    <div class="col-sm-6">
                        <div class="field-right">
                        <table class="table table--icons">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td><i class="fa fa-caret-square-o-left"></i></td>
                            ...
                            <tr>
                                <td><i class="fa fa-caret-square-o-up"></i></td>
                            ...
                            <tr>
                                <td><i class="fa fa-fire-extinguisher"></i></td>
                            ...
                            <tr>
                                <td><i class="fa fa-lemon-o"></i></td>
                                <td>fa fa-lemon-o</td>
                            </tr>

                            <tr>
                                <td><i class="fa fa-level-down"></i></td>
                    ...
                    <div class="col-sm-6">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td><i class="fa fa-mail-reply-all"></i></td>
                            ...
                            <tr>
                                <td><i class="fa fa-microphone-slash"></i></td>
                            ...
                            <tr>
                                <td><i class="fa fa-minus-square-o"></i></td>
                            ...
                            <tr>
                                <td><i class="fa fa-reply-all"></i></td>
                            ...
                            <tr>
                                <td><i class="fa fa-rss-square"></i></td>
                            ...
                            <tr>
                                <td><i class="fa fa-search-minus"></i></td>
                            ...
                            <tr>
                                <td><i class="fa fa-share-square-o"></i></td>
                            ...
                            <tr>
                                <td><i class="fa fa-sort-alpha-asc"></i></td>
                                <td>fa fa-sort-alpha-asc</td>
                            </tr>

                            <tr>
                                <td><i class="fa fa-sort-alpha-desc"></i></td>
                            ...
                            <tr>
                                <td><i class="fa fa-sort-down"></i></td>
                            ...
                            <tr>
                                <td><i class="fa fa-sort-numeric-desc"></i></td>
                                <td>fa fa-sort-numeric-desc</td>
                            </tr>

                            <tr>
                                <td><i class="fa fa-sort-up"></i></td>
                                <td>fa fa-sort-up</td>
                            </tr>
                            ...
                            <tr>
                                <td><i class="fa fa-star-half"></i></td>
                                <td>fa fa-star-half</td>
                            </tr>

                            <tr>
                                <td><i class="fa fa-star-half-empty"></i></td>
                            ...
                            <tr>
                                <td><i class="fa fa-subscript"></i></td>
                            ...
                            <tr>
                                <td><i class="fa fa-superscript"></i></td>
                            ...
                            <tr>
                                <td><i class="fa fa-toggle-left"></i></td>
                                <td>fa fa-toggle-left</td>
                            </tr>

                            <tr>
                                <td><i class="fa fa-toggle-right"></i></td>
                                <td>fa fa-toggle-right</td>
                            </tr>

                            <tr>
                                <td><i class="fa fa-toggle-up"></i></td>
                            ...
                            <tr>
                             ...
                             <tr>
                                <td><i class="fa fa-unsorted"></i></td>
                    ...
                    <div class="clearfix"></div>
                    <h2 class="heading heading--outcontainer heading--top">Usage (social)</h2>
